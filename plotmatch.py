...
# j=0
# matrix1=np.zeros((l, 2))
# matrix2=np.zeros((l, 2))
# for i in range(matches.shape[0]):
#     idx1 = matches[i, 0]
#     idx2 = matches[i, 1]
#     l=len( matches[:, 0])
#     matrix1[j, 0] = keypoints1[idx1, 0]
#     matrix1[j, 1] = keypoints1[idx1, 1]
#     matrix2[j, 0] = keypoints2[idx2, 0]
#     matrix2[j, 1] = keypoints2[idx2, 1]
#     j+=1
# 展示用的图，要不要用手动调成非常精确匹配的
